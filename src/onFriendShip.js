...
module.exports = async function onFriendShip(friendship) {
  ...
  try {
    ...
    console.log(logMsg,'friendship.type()',friendship.type())
    ...
    // switch (friendship.type()) {
      ...
      //   logMsg = "friend ship verified with " + friendship.contact().name()
      //   break
      // case Friendship.Type.Unknown:
      //   logMsg = "friend ship Unknown with " + friendship.contact().name()
      //   break
    // }
    console.log(logMsg)
  } catch (e) {
